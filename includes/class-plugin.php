...
class Plugin {
	...
	public function __construct() {
		$this->version     = '1.0.0';
		$this->plugin_name = 'prc-node-bylines';
	...
	private function load_dependencies() {
		...
		require_once plugin_dir_path( __DIR__ ) . '/includes/class-node.php';
		...
		require_once plugin_dir_path( __DIR__ ) . '/includes/class-bhi-postmeta.php';
	...
	/**
	 * Add an edit link to the admin bar for the current node post.
	 *
	 * @hook admin_bar_menu
	 *
	...
	public function modify_admin_bar_edit_link( $admin_bar ) {
		...
		$link = get_edit_post_link( $node->ID );
		$admin_bar->add_menu(
			array(
				'parent' => false,
				'id'     => 'edit_node',
	...
	public function enqueue_editor_assets() {
		...
		$this->enqueue_editor_asset( 'node-inspector-sidebar-panel', 'node' );
	}
	 ...
	 *
	 * @since     1.0.0
	 * @return    PRC\Platform\Node_System\Loader
	 */
